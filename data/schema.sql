create schema if not exists BD20_clasicos collate latin1_swedish_ci;
use BD20_clasicos;
...
(
    ...
    constraint empleados_ibfk_1
        foreign key (responsable) references empleados (empleadoId),
...
(
    ...
    pais             varchar(50)    not null,
    empleadoNumero   int            null,
    limiteCredito    decimal(10, 2) null,
    constraint clientes_ibfk_1
        foreign key (empleadoNumero) references empleados (empleadoId)
);

create index empleadoNumero
    on clientes (empleadoNumero);

create index oficinaId
    on empleados (oficinaId);

create index responsable
    on empleados (responsable);

create table if not exists pagos
(
    clienteId          int            not null,
    CodigoComprobacion varchar(50)    not null,
    fechaPago          date           not null,
    cantidad           decimal(10, 2) not null,
    primary key (clienteId, CodigoComprobacion),
...
(
    categoriaId      varchar(50)   not null
        primary key,
    descripcionTexto varchar(4000) null,
    descripcionHtml  mediumtext    null,
...
(
    productoId        varchar(15)    not null
        primary key,
    productoNombre    varchar(70)    not null,
    categoriaId       varchar(50)    not null,
    ...
    precioRecomendado decimal(10, 2) not null,
    constraint products_ibfk_1
        foreign key (categoriaId) references productoscategorias (categoriaId)
);
...
(
    ...
    constraint pedidodetalles_ibfk_1
        foreign key (pedidoId) references pedidos (pedidoId),
    constraint pedidodetalles_ibfk_2
        foreign key (productoId) references productos (productoId)
);

create index productoId
    on pedidodetalles (productoId);

create index categoriaId
    on productos (categoriaId);

INSERT INTO oficinas (`oficinaId`, `ciudad`, `telefono`, `direccion1`, `direccion2`, `provincia`, `pais`,
                      `codigoPostal`, `area`)
...
INSERT INTO empleados (`empleadoId`, `apellido`, `nombre`, `extension`, `email`, `oficinaId`, `responsable`, `puesto`)
...
INSERT INTO clientes (`clienteId`, `clienteNombre`, `contactoApellido`, `contactoNombre`, `telefono`, `direccion1`,
                      `direccion2`, `ciudad`, `provincia`, `codigoPostal`, `pais`, `empleadoNumero`, `limiteCredito`)
VALUES (103, 'Atelier graphique', 'Schmitt', 'Carine ', '40.32.2555', '54, rue Royale', NULL, 'Nantes', NULL, '44000',
     ...
     , (131, 'Land of Toys Inc.', 'Lee', 'Kwai', '2125557818', '897 Long Airport Avenue', NULL, 'NYC', 'NY', '10022',
        'USA', 1323, 114900.00)
     , (141, 'Euro+ Shopping Channel', 'Freyre', 'Diego ', '(91) 555 94 44', 'C/ Moralzarzal, 86', NULL, 'Madrid',
        'Madrid', '28034', 'Spain', 1370, 227600.00)
     ...
     , (216, 'Enaco Distributors', 'Saavedra', 'Eduardo ', '(93) 203 4555', 'Rambla de Cataluña, 23', NULL, 'Barcelona',
        'Barcelona', '08022', 'Spain', 1702, 60300.00)
     ...
     , (237, 'ANG Resellers', 'Camino', 'Alejandra ', '(91) 745 6555', 'Gran Vía, 1', NULL, 'Madrid', 'Madrid', '28001',
        'Spain', NULL, 0.00)
     ...
     , (344, 'CAF Imports', 'Fernandez', 'Jesus', '+34 913 728 555', 'Merchants House', '27-30 Merchant\'s Quay',
        'Madrid', 'Madrid', '28023', 'Spain', 1702, 59600.00)
     ...
     , (458, 'Corrida Auto Replicas, Ltd', 'Sommer', 'Martín ', '(91) 555 22 82', 'C/ Araquil, 67', NULL, 'Madrid',
        'Madrid', '28023', 'Spain', 1702, 104600.00)
     ...
     , (465, 'Anton Designs, Ltd.', 'Anton', 'Carmen', '+34 913 728555', 'c/ Gobelas, 19-1 Urb. La Florida', NULL,
        'Madrid', 'Madrid', '28023', 'Spain', NULL, 0.00)
     ...
     , (484, 'Iberia Gift Imports, Corp.', 'Roel', 'José Pedro ', '(95) 555 82 82', 'C/ Romero, 33', NULL, 'Sevilla',
        'Sevilla', '41101', 'Spain', 1702, 65700.00)
...
INSERT INTO productoscategorias (`categoriaId`, `descripcionTexto`, `descripcionHtml`, `foto`)
VALUES ('Aviones',
        'Réplicas únicas de aviones y helicópteros de fundición, adecuadas para colecciones, así como para decoraciones de hogares, oficinas o aulas. Los modelos contienen detalles impresionantes como logotipos e insignias oficiales, motores a reacción y hélices giratorias, ruedas retráctiles, etc. La mayoría vienen completamente ensamblados y con un certificado de autenticidad de sus fabricantes.',
        NULL, NULL)
     , ('Barcos',
        'El regalo de vacaciones o aniversario perfecto para ejecutivos, clientes, amigos y familiares. Estos modelos de barcos hechos a mano son únicas e impresionantes obras de arte que serán atesoradas por generaciones! Vienen completamente ensambladas y listas para ser exhibidas en el hogar o la oficina. Garantizamos la más alta calidad, y el mejor valor.',
        NULL, NULL)
     , ('Camiones y Autobuses',
        'Los modelos de camión y autobús son réplicas realistas de autobuses y camiones especializados producidos desde principios de los años 20 hasta la actualidad. Los modelos varían en tamaño de escala 1:12 a 1:50 e incluyen numerosas ediciones limitadas y varios vehículos fuera de producción. Los materiales utilizados incluyen el estaño, la fundición a presión y el plástico. Todos los modelos incluyen un certificado de autenticidad de sus fabricantes y son un adorno perfecto para el hogar y la oficina.',
        NULL, NULL)
     , ('Coches clásicos',
        'Atención entusiastas de los coches: Hagan realidad sus sueños más salvajes de poseer un coche. Ya sea que busques muscle cars clásicos, deportivos de ensueño o miniaturas inspiradas en películas, encontrarás grandes opciones en esta categoría. Estas réplicas se caracterizan por su magnífica atención al detalle y la artesanía y ofrecen características como un sistema de dirección que funciona, un compartimento delantero que se abre, un maletero trasero que se abre con una rueda de repuesto extraíble, una suspensión de muelle independiente en las cuatro ruedas, etc. Los modelos varían en tamaño de escala 1:10 a 1:24 e incluyen numerosas ediciones limitadas y varios vehículos fuera de producción. Todos los modelos incluyen un certificado de autenticidad de sus fabricantes y vienen completamente ensamblados y listos para su exhibición en el hogar o la oficina.',
        NULL, NULL)
     , ('Coches Vintage',
        'Nuestros modelos de coches antiguos representan de forma realista los automóviles producidos desde principios de 1900 hasta los años 40. Los materiales utilizados incluyen baquelita, fundición a presión, plástico y madera. La mayoría de las réplicas están en los tamaños de escala 1:18 y 1:24, que proporcionan el óptimo en detalle y precisión. Los precios van desde los 30 dólares hasta los 180 dólares por algunas réplicas especiales de edición limitada. Todos los modelos incluyen un certificado de autenticidad de sus fabricantes y vienen completamente ensamblados y listos para su exhibición en el hogar o la oficina.',
        NULL, NULL)
     , ('Motociletas',
        'Nuestras motos son la provincia de las réplicas de arte de leyendas de la motocicleta clásica y contemporánea como Harley Davidson, Ducati y Vespa. Los modelos contienen detalles impresionantes como los logotipos oficiales, ruedas giratorias, soporte de trabajo, suspensión delantera, palanca de cambios, palanca del freno de pie y cadena de transmisión. Los materiales utilizados incluyen el plástico y la fundición a presión. Los modelos varían en tamaño de escala 1:10 a 1:50 e incluyen numerosas ediciones limitadas y varios vehículos fuera de producción. Todos los modelos vienen completamente ensamblados y listos para ser exhibidos en el hogar o la oficina. La mayoría incluyen un certificado de autenticidad.',
        NULL, NULL)
     , ('Trenes',
        'Los modelos de trenes son un hobby gratificante para los entusiastas de todas las edades. Ya sea que busques trenes de madera coleccionables, tranvías eléctricos o locomotoras, encontrarás un gran número de opciones para cualquier presupuesto dentro de esta categoría. El aspecto interactivo de los trenes hace que los trenes de juguete sean perfectos para los niños pequeños. Los trenes de madera son ideales para niños menores de 5 años.',
        NULL, NULL)
;


INSERT INTO pagos (`clienteId`, `CodigoComprobacion`, `fechaPago`, `cantidad`)
...
INSERT INTO pedidos (`pedidoId`, `fechaEnvio`, `fechaLlegada`, `fechaPedido`, `estado`, `comentarios`, `clienteId`)
VALUES (10100, '2003-01-06', '2003-01-13', '2003-01-10', 'Enviado', NULL, 363)
     , (10101, '2003-01-09', '2003-01-18', '2003-01-11', 'Enviado', 'Comprobar la disponibilidad.', 128)
     ...
     , (10107, '2003-02-24', '2003-03-03', '2003-02-26', 'Enviado',
        'Difícil de negociar con el cliente. Necesitamos más material de marketing', 131)
     , (10108, '2003-03-03', '2003-03-12', '2003-03-08', 'Enviado', NULL, 385)
     , (10109, '2003-03-10', '2003-03-19', '2003-03-11', 'Enviado',
        'El cliente solicitó que se utilice Correos para este envío', 486)
     , (10110, '2003-03-18', '2003-03-24', '2003-03-20', 'Enviado', NULL, 187)
     , (10111, '2003-03-25', '2003-03-31', '2003-03-30', 'Enviado', NULL, 129)
     , (10112, '2003-03-24', '2003-04-03', '2003-03-29', 'Enviado',
        'El cliente solicitó que se incluyeran materiales publicitarios (como carteles, folletos) en el envío', 144)
     ...
     , (10118, '2003-04-21', '2003-04-29', '2003-04-26', 'Enviado',
        'El cliente ha trabajado con algunos de nuestros proveedores en el pasado y conoce su precioRecomendado', 216)
     ...
     , (10124, '2003-05-21', '2003-05-29', '2003-05-25', 'Enviado',
        'El cliente está muy preocupado por el color exacto de los modelos. Hay un alto riesgo de que pueda disputar el pedido porque hay un ligero desajuste de color',
        112)
     , (10125, '2003-05-21', '2003-05-27', '2003-05-24', 'Enviado', NULL, 114)
     , (10126, '2003-05-28', '2003-06-07', '2003-06-02', 'Enviado', NULL, 458)
     , (10127, '2003-06-03', '2003-06-09', '2003-06-06', 'Enviado',
        'El cliente solicitó un envío especial. Las instrucciones se pasaron al almacén', 151)
     ...
     , (10136, '2003-07-04', '2003-07-14', '2003-07-06', 'Enviado',
        'El cliente está interesado en comprar más modelos de Ferrari', 242)
     ...
     , (10143, '2003-08-10', '2003-08-18', '2003-08-12', 'Enviado',
        '¿Podemos entregar los nuevos modelos de Ford Mustang para el final del trimestre?', 320)
     ...
     , (10148, '2003-09-11', '2003-09-21', '2003-09-15', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con Finanzas.', 276)
     , (10149, '2003-09-12', '2003-09-18', '2003-09-17', 'Enviado', NULL, 487)
     , (10150, '2003-09-19', '2003-09-27', '2003-09-21', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con Finanzas.', 148)
     ...
     , (10164, '2003-10-21', '2003-10-30', '2003-10-23', 'Resuelto',
        'Esta orden fue disputada, pero resuelta el 11/1/2003. Al cliente no le gustan los colores y la precisión de los modelos.',
        452)
     , (10165, '2003-10-22', '2003-10-31', '2003-12-26', 'Enviado',
        'Esta orden estaba en espera porque el límite de crédito de los clientes se había excedido. El pedido se enviará cuando se reciba el pago.',
        148)
     , (10166, '2003-10-21', '2003-10-30', '2003-10-27', 'Enviado', NULL, 462)
     , (10167, '2003-10-23', '2003-10-30', NULL, 'Cancelado',
        'El cliente llamó para cancelar. El almacén fue notificado a tiempo y el pedido no se envió. Tienen un nuevo vicepresidente de ventas y están cambiando su modelo de ventas. Nuestro vicepresidente de ventas debería contactarlos.',
        448)
     ...
     , (10173, '2003-11-05', '2003-11-15', '2003-11-09', 'Enviado',
        'Un optimismo cauteloso. Tenemos clientes felices aquí, si podemos mantenerlos bien abastecidos.  Necesito toda la información que pueda conseguir sobre los envíos planeados de Porches',
        278)
     ...
     , (10178, '2003-11-08', '2003-11-16', '2003-11-10', 'Enviado',
        'Instrucciones de envío personalizadas enviadas al almacén', 242)
     , (10179, '2003-11-11', '2003-11-17', '2003-11-13', 'Cancelado',
        'Cliente cancelado por problemas urgentes de presupuesto. Hay que tener cuidado al tratar con ellos en el futuro. Como la orden ya ha sido enviada, debemos discutir quién cubrirá los gastos de envío.',
        496)
     ...
     , (10183, '2003-11-13', '2003-11-22', '2003-11-15', 'Enviado',
        'Necesitamos mantenernos en contacto con su Vicepresidente de Marketing. Él es el que toma las decisiones para todas sus compras.',
        339)
     , (10184, '2003-11-14', '2003-11-22', '2003-11-20', 'Enviado', NULL, 484)
     , (10185, '2003-11-14', '2003-11-21', '2003-11-20', 'Enviado', NULL, 320)
     , (10186, '2003-11-14', '2003-11-20', '2003-11-18', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con el Vicepresidente de Ventas', 489)
     , (10187, '2003-11-15', '2003-11-24', '2003-11-16', 'Enviado', NULL, 211)
     , (10188, '2003-11-18', '2003-11-26', '2003-11-24', 'Enviado', NULL, 167)
     , (10189, '2003-11-18', '2003-11-25', '2003-11-24', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con Finanzas.', 205)
     , (10190, '2003-11-19', '2003-11-29', '2003-11-20', 'Enviado', NULL, 141)
     , (10191, '2003-11-20', '2003-11-30', '2003-11-24', 'Enviado',
        'Debemos tener cuidado con este cliente. Su vicepresidente de ventas renunció. La compañía puede estar bajando.',
        259)
     ...
     , (10197, '2003-11-26', '2003-12-02', '2003-12-01', 'Enviado',
        'El cliente preguntó sobre los modelos a control remoto y los modelos de oro.', 216)
     ...
     , (10205, '2003-12-03', '2003-12-09', '2003-12-07', 'Enviado',
        'Necesito toda la información que pueda conseguir sobre nuestros competidores.', 141)
     , (10206, '2003-12-05', '2003-12-13', '2003-12-08', 'Enviado', '¿Podemos negociar?', 202)
     , (10207, '2003-12-09', '2003-12-17', '2003-12-11', 'Enviado', 'Comprobar la disponibilidad.', 495)
     ...
     , (10213, '2004-01-22', '2004-01-28', '2004-01-27', 'Enviado',
        'Difícil de negociar con el cliente. Necesitamos más material de marketing', 489)
     , (10214, '2004-01-26', '2004-02-04', '2004-01-29', 'Enviado', NULL, 458)
     , (10215, '2004-01-29', '2004-02-08', '2004-02-01', 'Enviado',
        'El cliente solicitó que se utilice Correos para este envío', 475)
     , (10216, '2004-02-02', '2004-02-10', '2004-02-04', 'Enviado', NULL, 256)
     , (10217, '2004-02-04', '2004-02-14', '2004-02-06', 'Enviado', NULL, 166)
     , (10218, '2004-02-09', '2004-02-16', '2004-02-11', 'Enviado',
        'El cliente solicitó que se incluyeran materiales publicitarios (como carteles, folletos) en el envío', 473)
     ...
     , (10224, '2004-02-21', '2004-03-02', '2004-02-26', 'Enviado',
        'El cliente ha trabajado con algunos de nuestros proveedores en el pasado y conoce su precioRecomendado', 171)
     ...
     , (10230, '2004-03-15', '2004-03-24', '2004-03-20', 'Enviado',
        'El cliente está muy preocupado por el color exacto de los modelos. Hay un alto riesgo de que pueda disputar el pedido porque hay un ligero desajuste de color',
        128)
     , (10231, '2004-03-19', '2004-03-26', '2004-03-25', 'Enviado', NULL, 344)
     , (10232, '2004-03-20', '2004-03-30', '2004-03-25', 'Enviado', NULL, 240)
     , (10233, '2004-03-29', '2004-04-04', '2004-04-02', 'Enviado',
        'El cliente solicitó un envío especial. Las instrucciones se pasaron al almacén', 328)
     ...
     , (10242, '2004-04-20', '2004-04-28', '2004-04-25', 'Enviado',
        'El cliente está interesado en comprar más modelos de Ferrari', 456)
     ...
     , (10248, '2004-05-07', '2004-05-14', NULL, 'Cancelado',
        'El pedido se hizo por error. El almacén se dio cuenta de la falta de documentación.', 131)
     , (10249, '2004-05-08', '2004-05-17', '2004-05-11', 'Enviado',
        '¿Podemos entregar los nuevos modelos de Ford Mustang para el final del trimestre?', 173)
     ...
     , (10253, '2004-06-01', '2004-06-09', '2004-06-02', 'Cancelado',
        'El cliente disputó el pedido y acordamos cancelarlo. Debemos ser más cautelosos con este cliente en el futuro, ya que son muy difíciles de complacer. Debemos cubrir los gastos de envío.',
        201)
     , (10254, '2004-06-03', '2004-06-13', '2004-06-04', 'Enviado',
        'El cliente solicitó que se utilice DHL para este envío', 323)
     ...
     , (10260, '2004-06-16', '2004-06-22', NULL, 'Cancelado',
        'El cliente escuchó las quejas de sus clientes y llamó para cancelar este pedido. Notificará al gerente de ventas.',
        357)
     , (10261, '2004-06-17', '2004-06-25', '2004-06-22', 'Enviado', NULL, 233)
     , (10262, '2004-06-24', '2004-07-01', NULL, 'Cancelado',
        'El cliente escuchó las quejas de sus clientes y llamó para cancelar este pedido. Notificará al gerente de ventas.',
        141)
     , (10263, '2004-06-28', '2004-07-04', '2004-07-02', 'Enviado', NULL, 175)
     , (10264, '2004-06-30', '2004-07-06', '2004-07-01', 'Enviado',
        'El cliente enviará un camión a nuestro almacén local el 7/1/2004', 362)
     ...
     , (10270, '2004-07-19', '2004-07-27', '2004-07-24', 'Enviado', '¿Podemos negociar?', 282)
     ...
     , (10279, '2004-08-09', '2004-08-19', '2004-08-15', 'Enviado',
        'Un optimismo cauteloso. Tenemos clientes felices aquí, si podemos mantenerlos bien abastecidos.  Necesito toda la información que pueda conseguir sobre los envíos planeados de Porches',
        141)
     ...
     , (10284, '2004-08-21', '2004-08-29', '2004-08-26', 'Enviado',
        'Instrucciones de envío personalizadas enviadas al almacén', 299)
     ...
     , (10289, '2004-09-03', '2004-09-13', '2004-09-04', 'Enviado',
        'Necesitamos mantenernos en contacto con su Vicepresidente de Marketing. Él es el que toma las decisiones para todas sus compras.',
        167)
     , (10290, '2004-09-07', '2004-09-15', '2004-09-13', 'Enviado', NULL, 198)
     , (10291, '2004-09-08', '2004-09-17', '2004-09-14', 'Enviado', NULL, 448)
     , (10292, '2004-09-08', '2004-09-18', '2004-09-11', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con Finanzas.', 131)
     , (10293, '2004-09-09', '2004-09-18', '2004-09-14', 'Enviado', NULL, 249)
     , (10294, '2004-09-10', '2004-09-17', '2004-09-14', 'Enviado', NULL, 204)
     , (10295, '2004-09-10', '2004-09-17', '2004-09-14', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con Finanzas.', 362)
     , (10296, '2004-09-15', '2004-09-22', '2004-09-16', 'Enviado', NULL, 415)
     , (10297, '2004-09-16', '2004-09-22', '2004-09-21', 'Enviado',
        'Debemos tener cuidado con este cliente. Su vicepresidente de ventas renunció. La compañía puede estar bajando.',
        189)
     ...
     , (10303, '2004-10-06', '2004-10-14', '2004-10-09', 'Enviado',
        'El cliente preguntó sobre los modelos a control remoto y los modelos de oro.', 484)
     , (10304, '2004-10-11', '2004-10-20', '2004-10-17', 'Enviado', NULL, 256)
     , (10305, '2004-10-13', '2004-10-22', '2004-10-15', 'Enviado', 'Comprobar la disponibilidad.', 286)
     , (10306, '2004-10-14', '2004-10-21', '2004-10-17', 'Enviado', NULL, 187)
     , (10307, '2004-10-14', '2004-10-23', '2004-10-20', 'Enviado', NULL, 339)
     , (10308, '2004-10-15', '2004-10-24', '2004-10-20', 'Enviado',
        'El cliente solicitó que se utilice Correos para este envío', 319)
     , (10309, '2004-10-15', '2004-10-24', '2004-10-18', 'Enviado', NULL, 121)
     , (10310, '2004-10-16', '2004-10-24', '2004-10-18', 'Enviado', NULL, 259)
     , (10311, '2004-10-16', '2004-10-23', '2004-10-20', 'Enviado',
        'Difícil de negociar con el cliente. Necesitamos más material de marketing', 141)
     , (10312, '2004-10-21', '2004-10-27', '2004-10-23', 'Enviado', NULL, 124)
     , (10313, '2004-10-22', '2004-10-28', '2004-10-25', 'Enviado',
        'El cliente solicitó que se utilice Correos para este envío', 202)
     , (10314, '2004-10-22', '2004-11-01', '2004-10-23', 'Enviado', NULL, 227)
     , (10315, '2004-10-29', '2004-11-08', '2004-10-30', 'Enviado', NULL, 119)
     , (10316, '2004-11-01', '2004-11-09', '2004-11-07', 'Enviado',
        'El cliente solicitó que se incluyeran materiales publicitarios (como carteles, folletos) en el envío', 240)
     , (10317, '2004-11-02', '2004-11-12', '2004-11-08', 'Enviado', NULL, 161)
     , (10318, '2004-11-02', '2004-11-09', '2004-11-07', 'Enviado', NULL, 157)
     , (10319, '2004-11-03', '2004-11-11', '2004-11-06', 'Enviado',
        'El cliente solicitó que se utilice DHL para este envío', 456)
     , (10320, '2004-11-03', '2004-11-13', '2004-11-07', 'Enviado', NULL, 144)
     , (10321, '2004-11-04', '2004-11-12', '2004-11-07', 'Enviado', NULL, 462)
     , (10322, '2004-11-04', '2004-11-12', '2004-11-10', 'Enviado',
        'El cliente ha trabajado con algunos de nuestros proveedores en el pasado y conoce su precioRecomendado', 363)
     ...
     , (10327, '2004-11-10', '2004-11-19', '2004-11-13', 'Resuelto',
        'La orden fue disputada y resuelta el 12/1/04. El director de ventas estaba involucrado. El cliente afirma que las escalas de los modelos no coinciden con lo que se discutió.',
        145)
     , (10328, '2004-11-12', '2004-11-21', '2004-11-18', 'Enviado',
        'El cliente está muy preocupado por el color exacto de los modelos. Hay un alto riesgo de que pueda disputar el pedido porque hay un ligero desajuste de color',
        278)
     , (10329, '2004-11-15', '2004-11-24', '2004-11-16', 'Enviado', NULL, 131)
     , (10330, '2004-11-16', '2004-11-25', '2004-11-21', 'Enviado', NULL, 385)
     , (10331, '2004-11-17', '2004-11-23', '2004-11-23', 'Enviado',
        'El cliente solicitó un envío especial. Las instrucciones se pasaron al almacén', 486)
     , (10332, '2004-11-17', '2004-11-25', '2004-11-18', 'Enviado', NULL, 187)
     , (10333, '2004-11-18', '2004-11-27', '2004-11-20', 'Enviado', NULL, 129)
     , (10334, '2004-11-19', '2004-11-28', NULL, 'En espera',
        'El saldo exterior para este cliente excede su límite de crédito. El pedido será enviado cuando se reciba el pago.',
        144)
     , (10335, '2004-11-19', '2004-11-29', '2004-11-23', 'Enviado', NULL, 124)
     , (10336, '2004-11-20', '2004-11-26', '2004-11-24', 'Enviado',
        'El cliente solicitó que se utilice DHL para este envío', 172)
     ...
     , (10340, '2004-11-24', '2004-12-01', '2004-11-25', 'Enviado',
        'El cliente está interesado en comprar más modelos de Ferrari', 216)
     ...
     , (10347, '2004-11-29', '2004-12-07', '2004-11-30', 'Enviado',
        '¿Podemos entregar los nuevos modelos de Ford Mustang para el final del trimestre?', 114)
     ...
     , (10358, '2004-12-10', '2004-12-16', '2004-12-16', 'Enviado',
        'El cliente solicitó que se utilice DHL para este envío', 141)
     ...
     , (10367, '2005-01-12', '2005-01-21', '2005-01-16', 'Resuelto',
        'Esta orden fue impugnada y resuelta el 2/1/2005. El cliente alegó que el contenedor con el envío estaba dañado. La investigación de Correos demostró que esto estaba mal.',
        205)
     , (10368, '2005-01-19', '2005-01-27', '2005-01-24', 'Enviado', '¿Podemos negociar?', 124)
     ...
     , (10377, '2005-02-09', '2005-02-21', '2005-02-12', 'Enviado',
        'Un optimismo cauteloso. Tenemos clientes felices aquí, si podemos mantenerlos bien abastecidos.  Necesito toda la información que pueda conseguir sobre los envíos planeados de Porches',
        186)
     ...
     , (10382, '2005-02-17', '2005-02-23', '2005-02-18', 'Enviado',
        'Instrucciones de envío personalizadas enviadas al almacén', 124)
     ...
     , (10386, '2005-03-01', '2005-03-09', '2005-03-06', 'Resuelto',
        'En disputa then Resuelto on 3/15/2005. Customer doesn\'t like the craftsmaship of the models.', 141)
     , (10387, '2005-03-02', '2005-03-09', '2005-03-06', 'Enviado',
        'Necesitamos mantenernos en contacto con su Vicepresidente de Marketing. Él es el que toma las decisiones para todas sus compras.',
        148)
     , (10388, '2005-03-03', '2005-03-11', '2005-03-09', 'Enviado', NULL, 462)
     , (10389, '2005-03-03', '2005-03-09', '2005-03-08', 'Enviado', NULL, 448)
     , (10390, '2005-03-04', '2005-03-11', '2005-03-07', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con Finanzas.', 124)
     , (10391, '2005-03-09', '2005-03-20', '2005-03-15', 'Enviado', NULL, 276)
     , (10392, '2005-03-10', '2005-03-18', '2005-03-12', 'Enviado', NULL, 452)
     , (10393, '2005-03-11', '2005-03-22', '2005-03-14', 'Enviado',
        'Quieren reevaluar sus términos de acuerdo con Finanzas.', 323)
     , (10394, '2005-03-15', '2005-03-25', '2005-03-19', 'Enviado', NULL, 141)
     , (10395, '2005-03-17', '2005-03-24', '2005-03-23', 'Enviado',
        'Debemos tener cuidado con este cliente. Su vicepresidente de ventas renunció. La compañía puede estar bajando.',
        250)
     ...
     , (10400, '2005-04-01', '2005-04-11', '2005-04-04', 'Enviado',
        'El cliente solicitó que se utilice DHL para este envío', 450)
     , (10401, '2005-04-03', '2005-04-14', NULL, 'En espera',
        'Límite de crédito del cliente excedido. Se enviará cuando se reciba el pago.', 328)
     ...
     , (10406, '2005-04-15', '2005-04-25', '2005-04-21', 'En disputa',
        'El cliente afirma que el contenedor con el envío se dañó durante el transporte y que faltaban algunos artículos. Estoy hablando con Correos sobre esto.',
        145)
     , (10407, '2005-04-22', '2005-05-04', NULL, 'En espera',
        'Límite de crédito del cliente excedido. Se enviará cuando se reciba el pago.', 450)
     ...
     , (10413, '2005-05-05', '2005-05-14', '2005-05-09', 'Enviado',
        'El cliente solicitó que se utilice DHL para este envío', 175)
     , (10414, '2005-05-06', '2005-05-13', NULL, 'En espera',
        'Límite de crédito del cliente excedido. Se enviará cuando se reciba el pago.', 362)
     , (10415, '2005-05-09', '2005-05-20', '2005-05-12', 'En disputa',
        'El cliente afirma que las escalas de los modelos no coinciden con lo que se discutió. Sin embargo, guardo todo el papeleo para demostrar lo contrario.',
        471)
     , (10416, '2005-05-10', '2005-05-16', '2005-05-14', 'Enviado', NULL, 386)
     , (10417, '2005-05-13', '2005-05-19', '2005-05-19', 'En disputa',
        'Al cliente no le gustan los colores y la precisión de los modelos.', 141)
     , (10418, '2005-05-16', '2005-05-24', '2005-05-20', 'Enviado', NULL, 412)
     , (10419, '2005-05-17', '2005-05-28', '2005-05-19', 'Enviado', NULL, 382)
     , (10420, '2005-05-29', '2005-06-07', NULL, 'En proceso', NULL, 282)
     , (10421, '2005-05-29', '2005-06-06', NULL, 'En proceso',
        'Las instrucciones de envío personalizadas se enviaron al almacén', 124)
     , (10422, '2005-05-30', '2005-06-11', NULL, 'En proceso', NULL, 157)
     , (10423, '2005-05-30', '2005-06-05', NULL, 'En proceso', NULL, 314)
     , (10424, '2005-05-31', '2005-06-08', NULL, 'En proceso', NULL, 141)
     , (10425, '2005-05-31', '2005-06-07', NULL, 'En proceso', NULL, 119)
;

INSERT INTO productos (`productoId`, `productoNombre`, `categoriaId`, `escala`, `proveedor`, `descripcion`, `stock`,
                       `precioCoste`, `precioRecomendado`)
VALUES ('S10_1678', '1969 Harley Davidson Ultimate Chopper', 'Motociletas', '1:10', 'Min Lin Diecast',
        'Esta réplica cuenta con un pie de apoyo, suspensión delantera, palanca de cambio, palanca de freno de pie, cadena de transmisión, ruedas y dirección. Todas las piezas son especialmente delicadas debido a su escala precisa y requieren un cuidado y atención especial.',
        7933, 48.81, 95.70)
     , ('S10_1949', '1952 Alpine Renault 1300', 'Coches clásicos', '1:10', 'Classic Metal Creations',
        'Ruedas delanteras giratorias; función de dirección; interior detallado; motor detallado; apertura del capó; apertura del maletero; apertura de puertas; y chasis detallado.',
        7305, 98.58, 214.30)
     , ('S10_2016', '1996 Moto Guzzi 1100i', 'Motociletas', '1:10', 'Highway 66 Mini Classics',
        'Logotipos e insignias oficiales de Moto Guzzi, alforjas situadas en el lateral de la moto, motor detallado, dirección funcional, suspensión funcional, dos asientos de cuero, portaequipajes, tubos de escape dobles, pequeña alforja situada en los manillares, pintura bicolor con detalles cromados, detalle superior fundido a presión, ruedas giratorias, soporte de patada funcional, metal fundido a presión con piezas de plástico y acabado de esmalte al horno.',
        6625, 68.99, 118.94)
     , ('S10_4698', '2003 Harley-Davidson Eagle Drag Bike', 'Motociletas', '1:10', 'Red Start Diecast',
        'Características del modelo, logotipos e insignias oficiales de Harley Davidson, barra de tracción trasera desmontable, metal fundido a presión con piezas de resina, gráficos auténticos multicolores impresos a mano, correas de transmisión del motor separadas, horquilla delantera de giro libre, neumáticos giratorios y neumáticos traseros de competición, certificado de autenticidad, motor detallado, expositor, réplica de precisión fundida a presión, acabado de esmalte al horno, modelo a escala 1:10, guardabarros extraíble, asiento y cubierta del depósito para mostrar el detalle superior del motor bicilíndrico en V.',
        5582, 91.02, 193.66)
     , ('S10_4757', '1972 Alfa Romeo GTA', 'Coches clásicos', '1:10', 'Motor City Art Classics',
        'Features include: Ruedas delanteras giratorias; función de dirección; interior detallado; motor detallado; apertura del capó; apertura del maletero; apertura de puertas; y chasis detallado.',
        3252, 85.68, 136.00)
     , ('S10_4962', '1962 LanciaA Delta 16V', 'Coches clásicos', '1:10', 'Second Gear Diecast',
        'Features include: Ruedas delanteras giratorias; función de dirección; interior detallado; motor detallado; apertura del capó; apertura del maletero; apertura de puertas; y chasis detallado.',
        6791, 103.42, 147.74)
     , ('S12_1099', '1968 Ford Mustang', 'Coches clásicos', '1:12', 'Autoart Studio Design',
        ...
        68, 95.34, 194.57)
     , ('S12_1108', '2001 Ferrari Enzo', 'Coches clásicos', '1:12', 'Second Gear Diecast',
        'Ruedas delanteras giratorias; función de dirección; interior detallado; motor detallado; apertura del capó; apertura del maletero; apertura de puertas; y chasis detallado.',
        3619, 95.59, 207.80)
     , ('S12_1666', '1958 Setra Bus', 'Camiones y Autobuses', '1:12', 'Welly Diecast Productions',
        'Model features 30 windows, skylights & glare resistant glass, working steering system, original logos', 1579,
        77.90, 136.67)
     , ('S12_2823', '2002 Suzuki XREO', 'Motociletas', '1:12', 'Unimax Art Galleries',
        ...
        9997, 66.27, 150.62)
     , ('S12_3148', '1969 Corvair Monza', 'Coches clásicos', '1:18', 'Welly Diecast Productions',
        '1:18 scale die-cast about 10\" long doors open, hood opens, trunk opens and wheels roll', 6906, 89.14, 151.08)
     , ('S12_3380', '1968 Dodge Charger', 'Coches clásicos', '1:12', 'Welly Diecast Productions',
        ...
        9123, 75.16, 117.44)
     , ('S12_3891', '1969 Ford Falcon', 'Coches clásicos', '1:12', 'Second Gear Diecast',
        'Ruedas delanteras giratorias; función de dirección; interior detallado; motor detallado; apertura del capó; apertura del maletero; apertura de puertas; y chasis detallado.',
        1049, 83.05, 173.02)
     , ('S12_3990', '1970 Plymouth Hemi Cuda', 'Coches clásicos', '1:12', 'Studio M Art Models',
        ...
        5663, 31.92, 79.80)
     , ('S12_4473', '1957 Chevy Pickup', 'Camiones y Autobuses', '1:12', 'Exoto Designs',
        '1:12 scale die-cast about 20\" long Hood opens, Rubber wheels', 6125, 55.70, 118.50)
     , ('S12_4675', '1969 Dodge Charger', 'Coches clásicos', '1:12', 'Welly Diecast Productions',
        ...
        7323, 58.73, 115.16)
     , ('S18_1097', '1940 Ford Pickup Truck', 'Camiones y Autobuses', '1:18', 'Studio M Art Models',
        ...
        2613, 58.33, 116.67)
     , ('S18_1129', '1993 Mazda RX-7', 'Coches clásicos', '1:18', 'Highway 66 Mini Classics',
        ...
        3975, 83.51, 141.54)
     , ('S18_1342', '1937 Lincoln Berline', 'Coches Vintage', '1:18', 'Motor City Art Classics',
        'Features opening engine cover, doors, trunk, and fuel filler cap. Color black', 8693, 60.62, 102.74)
     , ('S18_1367', '1936 Mercedes-Benz 500K Special Roadster', 'Coches Vintage', '1:18', 'Studio M Art Models',
        ...
        8635, 24.26, 53.91)
     , ('S18_1589', '1965 Aston Martin DB5', 'Coches clásicos', '1:18', 'Classic Metal Creations',
        ...
        9042, 65.96, 124.44)
     , ('S18_1662', '1980s Black Hawk Helicopter', 'Aviones', '1:18', 'Red Start Diecast',
        ...
        5330, 77.27, 157.69)
     , ('S18_1749', '1917 Grand Touring Sedan', 'Coches Vintage', '1:18', 'Welly Diecast Productions',
        ...
        2724, 86.70, 170.00)
     , ('S18_1889', '1948 Porsche 356-A Roadster', 'Coches clásicos', '1:18', 'Gearbox Collectibles',
        ...
        8826, 53.90, 77.00)
     , ('S18_1984', '1995 Honda Civic', 'Coches clásicos', '1:18', 'Min Lin Diecast',
        ...
        9772, 93.89, 142.25)
     , ('S18_2238', '1998 Chrysler Plymouth Prowler', 'Coches clásicos', '1:18', 'Gearbox Collectibles',
        'Ruedas delanteras giratorias; función de dirección; interior detallado; motor detallado; apertura del capó; apertura del maletero; apertura de puertas; y chasis detallado.',
        4724, 101.51, 163.73)
     , ('S18_2248', '1911 Ford Town Car', 'Coches Vintage', '1:18', 'Motor City Art Classics',
        'Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system.',
        540, 33.30, 60.54)
     , ('S18_2319', '1964 Mercedes Tour Bus', 'Camiones y Autobuses', '1:18', 'Unimax Art Galleries',
        'Exact replica. 100+ parts. working steering system, original logos', 8258, 74.86, 122.73)
     , ('S18_2325', '1932 Model A Ford J-Coupe', 'Coches Vintage', '1:18', 'Autoart Studio Design',
        ...
        9354, 58.48, 127.13)
     , ('S18_2432', '1926 Ford Fire Engine', 'Camiones y Autobuses', '1:18', 'Carousel DieCast Legends',
        'Gleaming red handsome appearance. Everything is here the fire hoses, ladder, axes, bells, lanterns, ready to fight any inferno.',
        2018, 24.92, 60.77)
     , ('S18_2581', 'P-51-D Mustang', 'Aviones', '1:72', 'Gearbox Collectibles',
        'Has retractable wheels and comes with a stand', 992, 49.00, 84.48)
     , ('S18_2625', '1936 Harley Davidson El Knucklehead', 'Motociletas', '1:18', 'Welly Diecast Productions',
        'Intricately detailed with chrome accents and trim, official die-struck logos and baked enamel finish.', 4357,
        24.23, 60.57)
     , ('S18_2795', '1928 Mercedes-Benz SSK', 'Coches Vintage', '1:18', 'Gearbox Collectibles',
        ...
        548, 72.56, 168.75)
     , ('S18_2870', '1999 Indy 500 Monte Carlo SS', 'Coches clásicos', '1:18', 'Red Start Diecast',
     ...
     , ('S18_2949', '1913 Ford Model T Speedster', 'Coches Vintage', '1:18', 'Carousel DieCast Legends',
        'This 250 part reproduction includes moving handbrakes, clutch, throttle and foot pedals, squeezable horn, detailed wired engine, removable water, gas, and oil cans, pivoting monocle windshield, all topped with a baked enamel red finish. Each replica comes with an Owners Title and Certificate of Authenticiudad. Color red.',
        4189, 60.78, 101.31)
     , ('S18_2957', '1934 Ford V8 Coupe', 'Coches Vintage', '1:18', 'Min Lin Diecast',
        'Chrome Trim, Chrome Grille, Opening Hood, Opening Doors, Opening Trunk, Detailed Engine, Working Steering System',
        5649, 34.35, 62.46)
     , ('S18_3029', '1999 Yamaha Speed Boat', 'Barcos', '1:18', 'Min Lin Diecast',
        'Réplica exacta. Madera y metal. Muchos extras, incluyendo jarcias, barcos largos, casa de pilotos, anclas, etc. Viene con tres mástiles, todos de aparejo cuadrado.',
        4259, 51.61, 86.02)
     , ('S18_3136', '18th Century Vintage Horse Carriage', 'Coches Vintage', '1:18', 'Red Start Diecast',
        ...
        5992, 60.74, 104.72)
     , ('S18_3140', '1903 Ford Model A', 'Coches Vintage', '1:18', 'Unimax Art Galleries',
        'Features opening trunk,  working steering system', 3913, 68.30, 136.59)
     , ('S18_3232', '1992 Ferrari 360 Spider red', 'Coches clásicos', '1:18', 'Unimax Art Galleries',
        ...
        8347, 77.90, 169.34)
     , ('S18_3233', '1985 Toyota Supra', 'Coches clásicos', '1:18', 'Highway 66 Mini Classics',
        'This model features soft rubber tires, working steering, rubber mud guards, authentic Ford logos, detailed undercarriage, opening doors and hood, removable split rear gate, full size spare mounted in bed, detailed interior with opening glove box',
        7733, 57.01, 107.57)
     , ('S18_3259', 'Collectable Wooden Train', 'Trenes', '1:18', 'Carousel DieCast Legends',
        ...
        6450, 67.56, 100.84)
     , ('S18_3278', '1969 Dodge Super Bee', 'Coches clásicos', '1:18', 'Min Lin Diecast',
        ...
        1917, 49.05, 80.41)
     , ('S18_3320', '1917 Maxwell Touring Car', 'Coches Vintage', '1:18', 'Exoto Designs',
        ...
        7913, 57.54, 99.21)
     , ('S18_3482', '1976 Ford Gran Torino', 'Coches clásicos', '1:18', 'Gearbox Collectibles',
        ...
        9127, 73.49, 146.99)
     , ('S18_3685', '1948 Porsche Type 356 Roadster', 'Coches clásicos', '1:18', 'Gearbox Collectibles',
        ...
        8990, 62.16, 141.28)
     , ('S18_3782', '1957 Vespa GS150', 'Motociletas', '1:18', 'Studio M Art Models',
        'Features rotating wheels , working kick stand. Comes with stand.', 7689, 32.95, 62.17)
     , ('S18_3856', '1941 Chevrolet Special Deluxe Cabriolet', 'Coches Vintage', '1:18', 'Exoto Designs',
        ...
        2378, 64.58, 105.87)
     , ('S18_4027', '1970 Triumph Spitfire', 'Coches clásicos', '1:18', 'Min Lin Diecast',
        'Features include opening and closing doors. Color: White.', 5545, 91.92, 143.62)
     , ('S18_4409', '1932 Alfa Romeo 8C2300 Spider Sport', 'Coches Vintage', '1:18', 'Exoto Designs',
        ...
        6553, 43.26, 92.03)
     , ('S18_4522', '1904 Buick Runabout', 'Coches Vintage', '1:18', 'Exoto Designs',
        'Features opening trunk,  working steering system', 8290, 52.66, 87.77)
     , ('S18_4600', '1940s Ford truck', 'Camiones y Autobuses', '1:18', 'Motor City Art Classics',
        ...
        3128, 84.76, 121.08)
     , ('S18_4668', '1939 Cadillac Limousine', 'Coches Vintage', '1:18', 'Studio M Art Models',
        ...
        6645, 23.14, 50.31)
     , ('S18_4721', '1957 Corvette Convertible', 'Coches clásicos', '1:18', 'Classic Metal Creations',
        ...
        1249, 69.93, 148.80)
     , ('S18_4933', '1957 Ford Thunderbird', 'Coches clásicos', '1:18', 'Studio M Art Models',
        ...
        3209, 34.21, 71.27)
     , ('S24_1046', '1970 Chevy Chevelle SS 454', 'Coches clásicos', '1:24', 'Unimax Art Galleries',
        ...
        1005, 49.24, 73.49)
     , ('S24_1444', '1970 Dodge Coronet', 'Coches clásicos', '1:24', 'Highway 66 Mini Classics',
        '1:24 scale die-cast about 18\" long doors open, hood opens and rubber wheels', 4074, 32.37, 57.80)
     , ('S24_1578', '1997 BMW R 1100 S', 'Motociletas', '1:24', 'Autoart Studio Design',
        'Detailed scale replica with working suspension and constructed from over 70 parts', 7003, 60.86, 112.70)
     , ('S24_1628', '1966 Shelby Cobra 427 S/C', 'Coches clásicos', '1:24', 'Carousel DieCast Legends',
        ...
        8197, 29.18, 50.31)
     , ('S24_1785', '1928 British Royal Navy Airplane', 'Aviones', '1:24', 'Classic Metal Creations',
        'Official logos and insignias', 3627, 66.74, 109.42)
     , ('S24_1937', '1939 Chevrolet Deluxe Coupe', 'Coches Vintage', '1:24', 'Motor City Art Classics',
        ...
        7332, 22.57, 33.19)
     , ('S24_2000', '1960 BSA Gold Star DBD34', 'Motociletas', '1:24', 'Highway 66 Mini Classics',
        'Detailed scale replica with working suspension and constructed from over 70 parts', 15, 37.32, 76.17)
     , ('S24_2011', '18th century schooner', 'Barcos', '1:24', 'Carousel DieCast Legends',
        ...
        1898, 82.34, 122.89)
     , ('S24_2022', '1938 Cadillac V-16 Presidential Limousine', 'Coches Vintage', '1:24', 'Classic Metal Creations',
        'This 1:24 scale precision die cast replica of the 1938 Cadillac V-16 Presidential Limousine has all the details of the original, from the flags on the front to an opening back seat compartment complete with teletelefono and rifle. Features factory baked-enamel black finish, hood goddess ornament, working jump seats.',
        2847, 20.61, 44.80)
     , ('S24_2300', '1962 Volkswagen Microbus', 'Camiones y Autobuses', '1:24', 'Autoart Studio Design',
        ...
        2327, 61.34, 127.79)
     , ('S24_2360', '1982 Ducati 900 Monster', 'Motociletas', '1:24', 'Highway 66 Mini Classics',
        'Features two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand',
        6840, 47.10, 69.26)
     , ('S24_2766', '1949 Jaguar XK 120', 'Coches clásicos', '1:24', 'Classic Metal Creations',
        ...
        2350, 47.25, 90.87)
     , ('S24_2840', '1958 Chevy Corvette Limited Edition', 'Coches clásicos', '1:24', 'Carousel DieCast Legends',
        ...
        2542, 15.91, 35.36)
     , ('S24_2841', '1900s Vintage Bi-Plane', 'Aviones', '1:24', 'Autoart Studio Design',
        ...
        5942, 34.25, 68.51)
     , ('S24_2887', '1952 Citroen-15CV', 'Coches clásicos', '1:24', 'Exoto Designs',
        ...
        1452, 72.82, 117.44)
     , ('S24_2972', '1982 Lamborghini Diablo', 'Coches clásicos', '1:24', 'Second Gear Diecast',
        'This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.',
        7723, 16.24, 37.76)
     , ('S24_3151', '1912 Ford Model T Delivery Wagon', 'Coches Vintage', '1:24', 'Min Lin Diecast',
        ...
        9173, 46.91, 88.51)
     , ('S24_3191', '1969 Chevrolet Camaro Z28', 'Coches clásicos', '1:24', 'Exoto Designs',
        ...
        4695, 50.51, 85.61)
     , ('S24_3371', '1971 Alpine Renault 1600s', 'Coches clásicos', '1:24', 'Welly Diecast Productions',
        ...
        7995, 38.58, 61.23)
     , ('S24_3420', '1937 Horch 930V Limousine', 'Coches Vintage', '1:24', 'Autoart Studio Design',
        'Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system',
        2902, 26.30, 65.75)
     , ('S24_3432', '2002 Chevy Corvette', 'Coches clásicos', '1:24', 'Gearbox Collectibles',
        ...
        9446, 62.11, 107.08)
     , ('S24_3816', '1940 Ford Delivery Sedan', 'Coches Vintage', '1:24', 'Carousel DieCast Legends',
        'Chrome Trim, Chrome Grille, Opening Hood, Opening Doors, Opening Trunk, Detailed Engine, Working Steering System. Color black.',
        6621, 48.64, 83.86)
     , ('S24_3856', '1956 Porsche 356A Coupe', 'Coches clásicos', '1:18', 'Classic Metal Creations',
        'Features include: Ruedas delanteras giratorias; función de dirección; interior detallado; motor detallado; apertura del capó; apertura del maletero; apertura de puertas; y chasis detallado.',
        6600, 98.30, 140.43)
     , ('S24_3949', 'Corsair F4U ( Bird Cage)', 'Aviones', '1:24', 'Second Gear Diecast',
        'Has retractable wheels and comes with a stand. Official logos and insignias.', 6812, 29.34, 68.24)
     , ('S24_3969', '1936 Mercedes Benz 500k Roadster', 'Coches Vintage', '1:24', 'Red Start Diecast',
        ...
        2081, 21.75, 41.03)
     , ('S24_4048', '1992 Porsche Cayenne Turbo Silver', 'Coches clásicos', '1:24', 'Exoto Designs',
        'This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.',
        6582, 69.78, 118.28)
     , ('S24_4258', '1936 Chrysler Airflow', 'Coches Vintage', '1:24', 'Second Gear Diecast',
        'Features opening trunk,  working steering system. Color dark green.', 4710, 57.46, 97.39)
     , ('S24_4278', '1900s Vintage Tri-Plane', 'Aviones', '1:24', 'Unimax Art Galleries',
        ...
        2756, 36.23, 72.45)
     , ('S24_4620', '1961 Chevrolet Impala', 'Coches clásicos', '1:18', 'Classic Metal Creations',
        ...
        7869, 32.33, 80.84)
     , ('S32_1268', '1980’s GM Manhattan Express', 'Camiones y Autobuses', '1:32', 'Motor City Art Classics',
        ...
        5099, 53.93, 96.31)
     , ('S32_1374', '1997 BMW F650 ST', 'Motociletas', '1:32', 'Exoto Designs',
        'Features official die-struck logos and baked enamel finish. Comes with stand.', 178, 66.92, 99.89)
     , ('S32_2206', '1982 Ducati 996 R', 'Motociletas', '1:32', 'Gearbox Collectibles',
        'Features rotating wheels , working kick stand. Comes with stand.', 9241, 24.14, 40.23)
     , ('S32_2509', '1954 Greyhound Scenicruiser', 'Camiones y Autobuses', '1:32', 'Classic Metal Creations',
        'Model features bi-level seating, 50 windows, skylights & glare resistant glass, working steering system, original logos',
        2874, 25.98, 54.11)
     , ('S32_3207', '1950\'s Chicago Surface Lines Streetcar', 'Trenes', '1:32', 'Gearbox Collectibles',
        ...
        8601, 26.72, 62.14)
     , ('S32_3522', '1996 Peterbilt 379 Stake Bed with Outrigger', 'Camiones y Autobuses', '1:32', 'Red Start Diecast',
        ...
        814, 33.61, 64.64)
     , ('S32_4289', '1928 Ford Phaeton Deluxe', 'Coches Vintage', '1:32', 'Highway 66 Mini Classics',
        'This model features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system',
        136, 33.02, 68.79)
     , ('S32_4485', '1974 Ducati 350 Mk3 Desmo', 'Motociletas', '1:32', 'Second Gear Diecast',
        'This model features two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand',
        3341, 56.13, 102.05)
     , ('S50_1341', '1930 Buick Marquette Phaeton', 'Coches Vintage', '1:50', 'Studio M Art Models',
        'Features opening trunk,  working steering system', 7062, 27.06, 43.64)
     , ('S50_1392', 'Diamond T620 Semi-Skirted Tanker', 'Camiones y Autobuses', '1:50', 'Highway 66 Mini Classics',
        'Este modelo de edición limitada tiene licencia y está perfectamente escalado para Lionel Trenes. El Diamante T620 ha sido producido en una sólida fundición a presión y pintado con un acabado de esmalte horneado al fuego. Viene con un camión cisterna desmontable y es un modelo perfecto para añadir autenticidad a su tren estático o a la disposición del coche o simplemente para tenerlo en exposición.',
        1016, 68.29, 115.75)
     , ('S50_1514', '1962 City of Detroit Streetcar', 'Trenes', '1:50', 'Classic Metal Creations',
        'Este tranvía es una alegría de ver. Tiene 99 ventanas separadas, guías de cables eléctricos, interiores detallados con asientos, postes y controles de conducción, conjuntos de ruedas rodantes y giratorias, además de auténticos acabados de esmalte horneado de fábrica (Green Hornet para Chicago y Cream y Crimson para Boston).',
        1645, 37.49, 58.58)
     , ('S50_4713', '2002 Yamaha YZR M1', 'Motociletas', '1:50', 'Autoart Studio Design',
        'Features rotating wheels , working kick stand. Comes with stand.', 600, 34.17, 81.36)
     , ('S700_1138', 'The Schooner Bluenose', 'Barcos', '1:700', 'Autoart Studio Design',
        'Todo de madera con velas de lona. Mide 31 1/2 pulgadas de largo, 22 pulgadas de alto y 4 3/4 pulgadas de ancho. Muchos extras. La goleta Bluenose fue construida en Nueva Escocia en 1921 para pescar en las aguas bravas de la costa de Terranova. Debido a la destreza en las carreras de Bluenose se convirtió en el orgullo de todos los canadienses. Todavía aparece en los sellos y en la moneda canadiense, la Bluenose se perdió frente a Haití en 1946.',
        1897, 34.00, 66.67)
     , ('S700_1691', 'American Airlines: B767-300', 'Aviones', '1:700', 'Min Lin Diecast',
        'Réplicas exactas con logotipos e insignias oficiales y ruedas retráctiles', 5841, 51.15, 91.34)
     , ('S700_1938', 'The Mayflower', 'Barcos', '1:700', 'Studio M Art Models',
        'Mide 31 1/2 pulgadas de largo x 25 1/2 pulgadas de alto x 10 5/8 pulgadas de ancho. Toda la madera con la vela de lona. Los extras incluyen barcos largos, jarcias, escaleras, barandillas, anclas, cañones laterales, pintados a mano, etc.',
        737, 43.30, 86.61)
     , ('S700_2047', 'HMS Bounty', 'Barcos', '1:700', 'Unimax Art Galleries',
        'Mide 30 pulgadas de largo x 27 1/2 pulgadas de alto x 4 3/4 pulgadas de ancho. Muchos extras, incluyendo jarcias, botes largos, casa de pilotos, anclas, etc. Viene con tres mástiles, todos de aparejo cuadrado.',
        3501, 39.83, 90.52)
     , ('S700_2466', 'America West Airlines B757-200', 'Aviones', '1:700', 'Motor City Art Classics',
        'Logotipos e insignias oficiales. Sistema de dirección en funcionamiento. Motores a reacción giratorios', 9653,
        68.80, 99.72)
     , ('S700_2610', 'The USS Constitution Ship', 'Barcos', '1:700', 'Red Start Diecast',
        'Todo de madera con velas de lona. Mide 31 1/2N\" Longitud x 22 3/8\" Alto x 8 1/4\\N- Anchura. Los extras incluyen 4 barcos en cubierta, duende de mar en la proa, anclas, barandilla de cobre, casas de pilotos, etc.',
        7083, 33.97, 72.28)
     , ('S700_2824', '1982 Camaro Z28', 'Coches clásicos', '1:18', 'Carousel DieCast Legends',
        'Las características incluyen la apertura y el cierre de puertas. Color: Blanco. Mide aproximadamente 9 1/2\" Long.',
        6934, 46.53, 101.15)
     , ('S700_2834', 'ATA: B757-300', 'Aviones', '1:700', 'Highway 66 Mini Classics',
        'Réplicas exactas con logotipos e insignias oficiales y ruedas retráctiles', 7106, 59.33, 118.65)
     , ('S700_3167', 'F/A 18 Hornet 1/72', 'Aviones', '1:72', 'Motor City Art Classics',
        '10\" La envergadura del ala con los trenes de aterrizaje retráctiles. Viene con el piloto.', 551, 54.40, 80.00)
     , ('S700_3505', 'The Titanic', 'Barcos', '1:700', 'Carousel DieCast Legends',
        'El modelo completo mide 19 1/2 pulgadas de largo, 9 pulgadas de alto, 3 pulgadas de ancho y es en rojo/negro de granero. Toda la madera y el metal.',
        1956, 51.09, 100.17)
     , ('S700_3962', 'The Queen Mary', 'Barcos', '1:700', 'Welly Diecast Productions',
        'Réplica exacta. Madera y metal. Muchos extras, incluyendo jarcias, barcos largos, casa de pilotos, anclas, etc. Viene con tres mástiles, todos de aparejo cuadrado.',
        5088, 53.63, 99.31)
     , ('S700_4002', 'American Airlines: MD-11S', 'Aviones', '1:700', 'Second Gear Diecast',
        'Polished finish. Réplicas exactas con logotipos e insignias oficiales y ruedas retráctiles', 8820, 36.27,
        74.03)
     , ('S72_1253', 'Boeing X-32A JSF', 'Aviones', '1:72', 'Motor City Art Classics',
        '10\" La envergadura del ala con los trenes de aterrizaje retráctiles. Viene con el piloto.', 4857, 32.77,
        49.66)
     , ('S72_3212', 'Pont Yacht', 'Barcos', '1:72', 'Unimax Art Galleries',
        'Mmide 38 pulgadas de largo x 33 3/4 pulgadas de alto. Incluye un soporte. Muchos extras, incluyendo jarcias, botes largos, casa de pilotos, anclas, etc. Viene con 2 mástiles, todos de aparejo cuadrado.',
        414, 33.30, 54.60)
;

INSERT INTO pedidodetalles (`pedidoId`, `productoId`, `cantidadPedida`, `precioUnidad`, `numeroLinea`)
